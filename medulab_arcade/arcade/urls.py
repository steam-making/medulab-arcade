...
urlpatterns = [
    ...
    path('tools/content-finder/list/', views.content_finder_list, name='content_finder_list'),
    path('tools/content-finder/<int:submission_id>/delete/', views.content_finder_delete, name='content_finder_delete'),
    ...
    path('tools/content-idea-finder/thumbnail/submit/', views.content_idea_thumbnail_submit, name='content_idea_thumbnail_submit'),
    path('tools/content-idea-finder/thumbnail/list/', views.content_idea_thumbnail_list, name='content_idea_thumbnail_list'),
    path('tools/content-idea-finder/thumbnail/<int:submission_id>/delete/', views.content_idea_thumbnail_delete, name='content_idea_thumbnail_delete'),
    ...
    path('api/content-finder-draft/save/', views.api_content_finder_draft_save, name='api_content_finder_draft_save'),
    path('api/content-idea-finder-draft/save/', views.api_content_idea_finder_draft_save, name='api_content_idea_finder_draft_save'),
    path('tools/content-plan/', views.content_plan, name='content_plan'),
    path('api/content-plan-draft/save/', views.api_content_plan_draft_save, name='api_content_plan_draft_save'),
    path('tools/channel-branding/', views.channel_branding, name='channel_branding'),
    path('api/channel-branding-draft/save/', views.api_channel_branding_draft_save, name='api_channel_branding_draft_save'),
    ...
    path('gallery/post/<str:media_id>/exclude/', views.instagram_post_toggle_exclude, name='instagram_post_toggle_exclude'),
    ...
    path('admin-services/instagram/ai-upload/', views.instagram_ai_upload_start, name='instagram_ai_upload_start'),
    path('admin-services/instagram/ai-upload/analyze/', views.instagram_ai_upload_analyze, name='instagram_ai_upload_analyze'),
    path('admin-services/instagram/ai-upload/<int:draft_id>/publish/', views.instagram_ai_upload_publish, name='instagram_ai_upload_publish'),
    path('admin-services/instagram/ai-upload/<int:draft_id>/discard/', views.instagram_ai_upload_discard, name='instagram_ai_upload_discard'),
    ...
    path('consult/submit/', views.consult_inquiry_submit, name='consult_inquiry_submit'),
    ...
    path('admin-services/kakao-notify/connect/', views.kakao_notify_connect, name='kakao_notify_connect'),
    path('admin-services/kakao-notify/callback/', views.kakao_notify_callback, name='kakao_notify_callback'),
